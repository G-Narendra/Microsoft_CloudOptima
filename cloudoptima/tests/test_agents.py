...
_AGENT_CASES: list[
    ...
    (
        ArchitectAgent,
        AgentType.ARCHITECT,
        ("PROJECT NAME", "WORKLOAD TYPE", "REQUIREMENTS"),
        ("--- AZURE REGION ---", "--- DEPLOYMENT SCALE ---"),
        ("compute", "storage", "networking", "data"),
    ),
    (
        CostAnalystAgent,
        AgentType.COST_ANALYST,
        ("PROJECT NAME", "DEPLOYMENT SCALE", "REQUIREMENTS"),
        ("--- MONTHLY BUDGET (READ-ONLY REFERENCE) ---", "--- AZURE REGION ---", "--- REQUIRED SERVICES ---"),
    ...
    (
        ...
        AgentType.SECURITY,
        ("PROJECT NAME", "DEPLOYMENT SCALE", "REQUIREMENTS"),
        ("--- AZURE REGION ---", "--- REQUIRED SERVICES ---"),
        ("findings", "overall_risk_rating", "recommendations"),
    ),
    (
        ComplianceOfficerAgent,
        AgentType.COMPLIANCE,
        ("PROJECT NAME", "AZURE REGION", "REQUIREMENTS"),
        ("--- COMPLIANCE FRAMEWORKS ---", "ARCHITECT DESIGN (trusted pipeline output):"),
